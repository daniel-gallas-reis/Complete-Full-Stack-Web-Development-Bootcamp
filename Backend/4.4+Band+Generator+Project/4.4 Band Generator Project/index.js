...
app.post("/submit", (req, res) => {
  ...
  const nounNumber = Math.floor(Math.random()*noun.length);
  const adjNumber = Math.floor(Math.random()*adj.length);

  const bandName = adj[adjNumber] + " " + noun[nounNumber];

  // console.log(nounNumber + " " + adjNumber + " " + bandName);
